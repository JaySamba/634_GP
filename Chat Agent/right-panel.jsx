      ...
      <div className="rp-body">
          ...
          <table style={{ width: "100%", marginTop: 12, borderCollapse: "collapse" }}>
            <tbody>
              {[
                ...
                ["Owner", doc.owner],
                ["Retrieval source", "Pinecone vector index · supabase.docs"],
        ...
        {tab === "history" && <>
          ...
          <div style={{ marginTop: 12 }}>
            {[
              { v: doc.version, date: doc.updated, who: "HR Operations", note: "Current published version" },
